...
class LoraWeight(qax.ImplicitArray):
    ...
    def materialize(self):
        # Use stop_gradient to prevent gradient computation for 'w'
        w_stopped = lax.stop_gradient(self.w)
        return (w_stopped + self.get_scale() * self.b @ self.a).astype(self.w.dtype)
    ...
    def update(self, a=None, b=None):
        # Create a new LoraWeight with updated a or b
        return LoraWeight(
            w=self.w,
